...
/// #[derive(Serialize, Deserialize, PartialEq, Debug)]
/// struct Struct {
///     #[serde(with = "dbt_yaml::with::singleton_map")]
///     w: Enum,
///     #[serde(with = "dbt_yaml::with::singleton_map")]
///     x: Enum,
///     #[serde(with = "dbt_yaml::with::singleton_map")]
...
///     };
///
///     let yaml = dbt_yaml::to_string(&object).unwrap();
///     print!("{}", yaml);
///
///     let deserialized: Struct = dbt_yaml::from_str(&yaml).unwrap();
...
///     tagged_style: Inner,
///
///     #[serde(with = "dbt_yaml::with::singleton_map_recursive")]
...
///     print!("{}", yaml);
///
///     let deserialized: Outer = dbt_yaml::from_str(&yaml).unwrap();
///     assert_eq!(object, deserialized);
/// }
/// ```
///
...
///
///     let mut buf = Vec::new();
///     let mut serializer = dbt_yaml::Serializer::new(&mut buf);
///     dbt_yaml::with::singleton_map_recursive::serialize(&object, &mut serializer).unwrap();
///     io::stdout().write_all(&buf).unwrap();
///
///     let deserializer = dbt_yaml::Deserializer::from_slice(&buf);
///     let deserialized: Inner = dbt_yaml::with::singleton_map_recursive::deserialize(deserializer).unwrap();
///     assert_eq!(object, deserialized);
/// }
/// ```
