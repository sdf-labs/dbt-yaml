...
///
/// ```
/// use dbt_yaml::value::TaggedValue;
...
/// ";
///
/// let data: BTreeMap<String, TaggedValue> = dbt_yaml::from_str(yaml).unwrap();
...
impl<'de> EnumAccess<'de> for TaggedValue {
        ...
        V: DeserializeSeed<'de>,
    {
        ...
        Ok((value, ValueDeserializer::new(self.value)))
    }
}
